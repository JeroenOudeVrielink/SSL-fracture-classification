...
rsync -r annotations s3416402@login1.hb.hpc.rug.nl:/scratch/s3416402/AIML_half_size
...
srun --partition=gpushort --gpus-per-node=v100:1 --mem=64GB --time=1:00:00 --job-name=test --pty /bin/bash
