...
SAVE_PATH = "/home/jvrielink/fracture-attention-guidance/visualization/visualized_embedding_feature_maps"
IMG_DIR_PATH = "/home/jvrielink/fracture-attention-guidance/visualization/test_imgs"
MODEL_PATHS = [
    "/home/jvrielink/data/spark_models/spark_in224_bs64_weighted_masking_03-28_06:46:51/resnet50_1kpretrained_timm_style_ep300.pth"
    ...
    # "/home/jvrielink/data/moco_models/moco_v2_bs512_base_params_2024-03-20_02-36-24/checkpoint_0299.pth.tar",
    # "imgnet",
]
...
def str_to_pretrained_method(path):
    if "spark" in path:
        if "weighted_masking" in path:
            return "spark_weighted_masking"
        return "spark"
    elif "dinov1" in path:
        return "dinov1"
